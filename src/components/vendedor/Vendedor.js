...
const Vendedor = () => {
    ...
    const {showFormVendedor,formVendedor} = vendContext;
                ...
                <div className="containerInv">
                    <div className="navItems">
                        <ul>
                            ...
                            <li>
                                <div className="ADD" onClick={showFormVendedor}>
                    ...
                    { (formVendedor) ? <FormVendedor /> : null}
                    <DataVendedor />
                </div>
                {(alerta) ? <CardAlerts /> : null}
                {modal ? <Modals deleteItemVendedor={deleteItemVendedor} /> : null}
            </div>
        </div>
    );
}
